...
- Para los _tips_ de ahorro se tendrá en una base de datos pequeñas frases o recomendaciones que fomenten el hábito de ahorrar. Dichas frases y/o recomendaciones serán seleccionadas de manera aleatoria cada cierto tiempo para ser presentadas al usuario en el apartado de _Ahorros_ en la aplicación. 
