...
- [FireBase API](https://firebase.google.com/docs/reference) se utilizará para recordar y autentificar a los usuarios. También servirá para hacer un login automático y para permitir logearse rápida y sencillamente.
